...
<div class="container" style="margin-top: 150px; margin-bottom: 80px;">
    <div class="card shadow-sm">
     <div class="card-header py-3" style="background-color: #5da898;">
       <h4 class="mb-0 fw-bold text-white">Edit Mobil: {{ $mobil->nama }}</h4>
     </div>
            ...
            <form action="{{ route('mobil.update', $mobil->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="tahun_produksi" class="form-control" value="{{ $mobil->tahun_produksi }}">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="mb-4">
                    ...
                    @if($mobil->gambar)
                        ...
                        <img src="{{ asset('storage/'.$mobil->gambar) }}" width="100" class="rounded border">
                    @endif
                </div>

                <div class="d-flex justify-content-between">
                    <a href="{{ route('mobil.detail', $mobil->id) }}" class="btn btn-secondary">Batal</a>
